...
public interface AppCache {
    String appByPlatformTypeAndAppid = "mb:app:by-platform-type-and-appid";
    String appByAppid = "mb:app:by-appid";

    @Getter
    @AllArgsConstructor
    enum Strategy implements CacheStrategy {
        appByAppid(AppCache.appByAppid,
                false,
                Duration.ZERO,
                Duration.ofHours(1),
                Duration.ofMinutes(1)),

        appByPlatformTypeAndAppid(AppCache.appByPlatformTypeAndAppid,
                false,
                Duration.ZERO,
                Duration.ofHours(24),
                Duration.ofMinutes(1));
