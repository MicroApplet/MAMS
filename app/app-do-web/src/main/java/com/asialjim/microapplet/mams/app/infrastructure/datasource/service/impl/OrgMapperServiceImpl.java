...
import com.asialjim.microapplet.mams.app.infrastructure.datasource.mapper.OrgBaseMapper;
 ...
 */
@Repository
public class OrgMapperServiceImpl extends ServiceImpl<OrgBaseMapper, OrgPo> implements OrgMapperService {
     ...
     */
    @Override
    @Cacheable(value = AppletCache.Name.orgPoById, key = "#id")
    public OrgPo queryById(String id) {
        return getById(id);
    }
}