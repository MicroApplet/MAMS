...
import com.asialjim.microapplet.mams.app.infrastructure.datasource.mapper.AppBaseMapper;
 ...
 */
@Repository
public class AppMapperServiceImpl extends ServiceImpl<AppBaseMapper, AppPo> implements AppMapperService {
    /**
     * 按id查询
     *
     * @param id id
     ...
     */
    @Override
    @Cacheable(value = AppletCache.Name.appPoById, key = "#id")
    public AppPo queryById(String id) {
        return getById(id);
    }
