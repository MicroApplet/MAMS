 ...
 */
@HttpExchange
public interface WeChatOAuthUserClient {
    @GetExchange("/sns/oauth2/access_token")
    WeChatOAuthAccessTokenRes accessToken(@RequestAttribute(WeChatApiAttributes.SKIP_ACCESS_TOKEN) boolean skipAccessToken,
