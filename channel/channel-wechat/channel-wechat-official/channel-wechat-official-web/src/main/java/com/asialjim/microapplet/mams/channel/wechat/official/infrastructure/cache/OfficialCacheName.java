...
package com.asialjim.microapplet.mams.channel.wechat.official.infrastructure.cache;
 ...
 */
@Configuration
public class OfficialCacheName extends CacheNameAndTTLConfig {
    public interface Name {
        String officialAISession = "tmp:wechat:official:ai:session";
    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        placeholder("placeholder"),
        officialAISession(Name.officialAISession, Duration.ofMinutes(10),Duration.ofSeconds(10));
