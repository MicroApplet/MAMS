...
package com.asialjim.microapplet.mams.channel.wechat.infrastructure.cache;
 ...
 */
@Configuration
public class WeChatAppCacheName extends CacheNameAndTTLConfig {
    public interface Name {
        String accessToken = "tmp:wx:access-token";
        String accessTokenCached = "tmp:wx:access-token-cached";
        String accessTokenLock = "tmp:wx:access-token-lk";
        String app = "tmp:wx:app:index";
    }
