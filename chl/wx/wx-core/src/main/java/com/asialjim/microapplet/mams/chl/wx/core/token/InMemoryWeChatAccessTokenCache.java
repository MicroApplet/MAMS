 ...
 */
@Component
@ConditionalOnMissingBean(WeChatAccessTokenCache.class)
public class InMemoryWeChatAccessTokenCache implements WeChatAccessTokenCache {
    ...
    @Override
    public void set(String appid, String accessToken) {
        tokens.put(appid, accessToken);
    }
