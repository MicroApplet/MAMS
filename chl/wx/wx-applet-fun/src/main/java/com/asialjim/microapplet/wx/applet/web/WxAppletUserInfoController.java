...
package com.asialjim.microapplet.wx.applet.web;

import com.asialjim.microapplet.wx.applet.api.WxAppletUserInfoApi;
import com.asialjim.microapplet.wx.applet.service.WxAppletUserInfoService;
...
public class WxAppletUserInfoController implements WxAppletUserInfoApi {
    ...
    @Override
    @GetMapping("/login")
    public WxAppletUserSession login(@RequestParam String appid, @RequestParam String code) {
        return this.wxAppletUserInfoService.login(appid,code);
    }
}
