 ...
 */
@Configuration
public class SessionCacheName extends CacheNameAndTTLConfig {
    public interface Name {
        String userSessionByToken = "tmp:session:token";

    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        userSessionByToken(Name.userSessionByToken,Duration.ofMinutes(5L));
        ...
        Cache(String name, Duration nonNullTTL) {
            this(name, nonNullTTL, Duration.ofSeconds(10));
        }
