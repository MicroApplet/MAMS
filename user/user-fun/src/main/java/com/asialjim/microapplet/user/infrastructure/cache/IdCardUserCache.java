 ...
 */
public interface IdCardUserCache {
    String idCardUserByChlUserId = "mb:idcard-user:by-chl-user-id";
    String idCardUserByOpenid = "mb:idcard-user:by-openid";


    @Getter
    @AllArgsConstructor
    enum Strategy implements CacheStrategy {
        idCardUserByChlUserId(IdCardUserCache.idCardUserByChlUserId,
                false,
                Duration.ZERO,
                Duration.ofHours(2),
                Duration.ofMinutes(1)),

        idCardUserByOpenid(IdCardUserCache.idCardUserByOpenid,
                false,
                Duration.ZERO,
                Duration.ofHours(2),
                Duration.ofMinutes(1));
    ...
    @Configuration
    class IdCardUserCacheStrategyCollection extends CacheStrategyCollection {
        @Override
