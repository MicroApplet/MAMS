...
import com.asialjim.microapplet.user.service.IdCardUserService;
...
public class IdCardUserController implements IdCardUserApi {
    ...
    @Override
    @GetMapping("/query")
    public IdCardUserVo query(@RequestParam String platformType,
                              @RequestParam String appid,
                              @RequestParam String openid,
                              @RequestParam String idType){

        return this.idCardUserService.query(platformType,appid,openid,idType);
    }

    @Override
    @GetMapping("/queryList")
    public List<IdCardUserVo> queryList(String platformType, String appid, String openid) {
        return this.idCardUserService.queryList(platformType,appid,openid);
    }
     ...
     */
    @Override
    public IdCardUserVo linkIdCard(@Validated IdCardUserVo body) {
        return this.idCardUserService.linkIdCard( body);
    }
}