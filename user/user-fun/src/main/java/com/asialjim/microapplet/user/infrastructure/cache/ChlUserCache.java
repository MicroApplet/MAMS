 ...
 */
public interface ChlUserCache {
    String chlUserById = "mb:chl-user:by-id";
    String chlUserByOpenId = "mb:chl-user:by-openid";
    String chlUserByUnionid = "mb:chl-user:by-unionid";
    ...
    enum Strategy implements CacheStrategy {
        ...
        chlUserByUnionId(ChlUserCache.chlUserByUnionid,
                false,
                Duration.ZERO,
        ...
        chlUserByOpenId(ChlUserCache.chlUserByOpenId,
                false,
                Duration.ZERO,
                Duration.ofHours(2),
                Duration.ofMinutes(1)),

        chlUserById(ChlUserCache.chlUserById,
                false,
                Duration.ZERO,
                Duration.ofHours(2),
                Duration.ofMinutes(1));
    ...
    @Configuration
    class ChlUserCacheStrategyCollection extends CacheStrategyCollection {
        @Override
