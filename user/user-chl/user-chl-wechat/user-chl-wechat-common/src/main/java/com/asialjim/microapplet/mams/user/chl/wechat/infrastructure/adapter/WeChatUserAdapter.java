 ...
 */
public interface WeChatUserAdapter {

    /**
     * 微信渠道用户登录
     *
     * @param weChatAppChl {@link WeChatAppChl 微信渠道应用}
     * @param code         {@link String 用户授权码}
     * @return {@link UserChl }
     * @since 2025/4/10
     */
    UserChl login(WeChatAppChl weChatAppChl, String code);
}
