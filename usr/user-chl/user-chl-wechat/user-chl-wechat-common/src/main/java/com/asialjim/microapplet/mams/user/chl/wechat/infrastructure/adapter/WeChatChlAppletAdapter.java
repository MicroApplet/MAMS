 ...
 */
public interface WeChatChlAppletAdapter {

    /**
     * 根据微信公众平台appid，type 查询应用
     *
     * @param chlAppId   {@link String chlAppId}
     * @param chlAppType {@link ChlAppType chlAppType}
     * @return {@link WeChatAppChl }
     * @since 2025/4/10
     */
    WeChatAppChl queryByAppidAndType(String chlAppId, ChlAppType chlAppType);
}