...
package com.asialjim.microapplet.mams.wx.mp.infrastructure.repository.cache;
 ...
 */
@Configuration
public class ChlWxMpCache extends CacheNameAndTTLConfig {
    public interface Name {
        String oauthPageById = "tmp:wx:mp:oauth-page:by-id";
    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        oauthPageById(Name.oauthPageById);
