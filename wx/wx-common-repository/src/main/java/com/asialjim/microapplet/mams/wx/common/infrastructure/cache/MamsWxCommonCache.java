...
package com.asialjim.microapplet.mams.wx.common.infrastructure.cache;
 ...
 */
@Configuration
public class MamsWxCommonCache extends CacheNameAndTTLConfig {
    public interface Name {
        String wechatApiAccessToken = "tmp:wechat:api:access-token";
    }

    @Getter
    enum Cache implements CacheNameAndTTL {
        wechatApiAccessToken(Name.wechatApiAccessToken, Duration.ofMinutes(110L));
