    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-icon {
            ...
            background: #fa5151; border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
            color: #fff; font-size: 28px; font-weight: bold;
        }
        .error-code { font-size: 18px; color: #333; margin-bottom: 10px; font-weight: 600; }
        .error-desc { font-size: 15px; color: #666; margin-bottom: 30px; line-height: 1.5; }
        .close-btn {
            width: 100%; padding: 12px; font-size: 16px; color: #fff;
            background-color: #07c160; border: none; border-radius: 6px;
            cursor: pointer; -webkit-tap-highlight-color: transparent;
        }
        .close-btn:active { background-color: #06ae56; }
    </style>
</head>
<body>
<div class="error-box">
...
<script>
    function closePage(){
        if(typeof WeixinJSBridge!=='undefined'){
            ...
            window.close(); window.history.back(); window.location.href='about:blank';
        }
    }
</script>
</body>
