 ...
 */
public interface WxAppletUserInfoApi {
    String path = "/wx/applet/user";

    @GetMapping(value = "/phone/number/pure",produces = MediaType.TEXT_PLAIN_VALUE)
    String userPurePhoneNumber(@RequestParam String wxAppid,
